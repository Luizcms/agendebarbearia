...
import com.example.agendebarbearia.modelo.Pessoa
...
//transforma radiogroup todos
        val group = RadioGroupHelper(this, R.id.txt0, R.id.txt01,R.id.txt02,R.id.txt03,R.id.txt04,R.id.txt05,R.id.txt06, R.id.txt1, R.id.txt2, R.id.txt3, R.id.txt4, R.id.txt5, R.id.txt6,
            R.id.txt7, R.id.txt8, R.id.txt9, R.id.txt10, R.id.txt11, R.id.txt12, R.id.txt13, R.id.txt14, R.id.txt15, R.id.txt16, R.id.txt17,
            R.id.txt18, R.id.txt19, R.id.txt20, R.id.txt21, R.id.txt22, R.id.txt23, R.id.txt24, R.id.txt25, R.id.txt26, R.id.txt27, R.id.txt28,
            R.id.txt29, R.id.txt30,
            R.id.txt31, R.id.txt32, R.id.txt33, R.id.txt34, R.id.txt35, R.id.txt36, R.id.txt37, R.id.txt38, R.id.txt39,
            R.id.txt40, R.id.txt41,
            R.id.txt42, R.id.txt43, R.id.txt44, R.id.txt45, R.id.txt46, R.id.txt47, R.id.txt48, R.id.txt49, R.id.txt50,
...
// tabhost
       ...
       // tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).getBackground().setColorFilter(Color.RED, PorterDuff.Mode.MULTIPLY);
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/8")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (txt01!!.getText().toString().equals("reservado" , ignoreCase = true) or txt01!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/9")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (txt1 != null) {
                    if (txt1.getText().toString().contains("reservado", ignoreCase = true) or txt1!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/10")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (txt7!!.getText().toString().equals("reservado", ignoreCase = true) or txt7!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/11")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt13 != null) {
                ...
                if (txt13!!.getText().toString().equals("reservado", ignoreCase = true) or txt13!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/12")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt19 != null) {
                ...
                if (txt19!!.getText().toString().equals("reservado", ignoreCase = true) or txt19!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/13")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt25 != null) {
                ...
                if (txt25.getText().toString().equals("reservado", ignoreCase = true) or txt25!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/14")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt31 != null) {
                ...
                if (txt31!!.getText().toString().equals("reservado", ignoreCase = true) or txt31!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/15")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt37 != null) {
                ...
                if (txt37!!.getText().toString().equals("reservado", ignoreCase = true) or txt37!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/16")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt43 != null) {
                ...
                if (txt43!!.getText().toString().equals("reservado", ignoreCase = true) or txt43!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/17")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt49 != null) {
                ...
                if (txt49!!.getText().toString().equals("reservado", ignoreCase = true) or txt49!!.getText().toString().equals("indisponivel")) {
        ...
        ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/segunda/18")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val mensagem = dataSnapshot.getValue(String::class.java)
                if (txt55 != null) {
                ...
                if (txt55.getText().toString().equals("reservado", ignoreCase = true) or txt55!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/8")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt02.setText(mensagem)
         if (txt02.getText().toString().equals("reservado", ignoreCase = true) or txt02!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/9")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt2.setText(mensagem)
         if (txt2.getText().toString().equals("reservado", ignoreCase = true) or txt2!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/10")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt8.setText(mensagem)
         if (txt8.getText().toString().equals("reservado", ignoreCase = true) or txt8!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/11")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt14.setText(mensagem)
         if (txt14.getText().toString().equals("reservado", ignoreCase = true) or txt14!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/12")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt20.setText(mensagem)
         if (txt20.getText().toString().equals("reservado", ignoreCase = true) or txt20!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/13")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt26.setText(mensagem)
         if (txt26.getText().toString().equals("reservado", ignoreCase = true) or txt26!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/14")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt32.setText(mensagem)
         if (txt32.getText().toString().equals("reservado", ignoreCase = true) or txt32!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/15")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt38.setText(mensagem)
         if (txt38.getText().toString().equals("reservado", ignoreCase = true) or txt38!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/16")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt44.setText(mensagem)
         if (txt44.getText().toString().equals("reservado", ignoreCase = true) or txt44!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/17")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt50.setText(mensagem)
         if (txt50.getText().toString().equals("reservado", ignoreCase = true) or txt50!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/terca/18")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt56.setText(mensagem)
         if (txt56.getText().toString().equals("reservado", ignoreCase = true) or txt56!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/8")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt03.setText(mensagem)
         if (txt03.getText().toString().equals("reservado", ignoreCase = true) or txt03!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/9")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt3.setText(mensagem)
         if (txt3.getText().toString().equals("reservado", ignoreCase = true) or txt3!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/10")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt9.setText(mensagem)
         if (txt9.getText().toString().equals("reservado", ignoreCase = true) or txt9!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/11")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt15.setText(mensagem)
         if (txt15.getText().toString().equals("reservado", ignoreCase = true) or txt15!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/12")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt21.setText(mensagem)
         if (txt21.getText().toString().equals("reservado", ignoreCase = true) or txt21!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/13")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt27.setText(mensagem)
         if (txt27.getText().toString().equals("reservado", ignoreCase = true) or txt27!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/14")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt33.setText(mensagem)
         if (txt33.getText().toString().equals("reservado", ignoreCase = true) or txt33!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/15")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt39.setText(mensagem)
         if (txt39.getText().toString().equals("reservado", ignoreCase = true) or txt39!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/16")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt45.setText(mensagem)
         if (txt45.getText().toString().equals("reservado", ignoreCase = true) or txt45!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/17")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt51.setText(mensagem)
         if (txt51.getText().toString().equals("reservado", ignoreCase = true) or txt51!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quarta/18")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt57.setText(mensagem)
         if (txt57.getText().toString().equals("reservado", ignoreCase = true) or txt57!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/8")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt04.setText(mensagem)
         if (txt04.getText().toString().equals("reservado", ignoreCase = true) or txt04!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/9")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt4.setText(mensagem)
         if (txt4.getText().toString().equals("reservado", ignoreCase = true) or txt4!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/10")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt10.setText(mensagem)
         if (txt10.getText().toString().equals("reservado", ignoreCase = true) or txt10!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/11")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt16.setText(mensagem)
         if (txt16.getText().toString().equals("reservado", ignoreCase = true) or txt16!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/12")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt22.setText(mensagem)
         if (txt22.getText().toString().equals("reservado", ignoreCase = true) or txt22!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/13")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt28.setText(mensagem)
         if (txt28.getText().toString().equals("reservado", ignoreCase = true) or txt28!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/14")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt34.setText(mensagem)
         if (txt34.getText().toString().equals("reservado", ignoreCase = true) or txt34!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/15")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt40.setText(mensagem)
         if (txt40.getText().toString().equals("reservado", ignoreCase = true) or txt40!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/16")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt46.setText(mensagem)
         if (txt46.getText().toString().equals("reservado", ignoreCase = true) or txt46!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/17")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt52.setText(mensagem)
         if (txt52.getText().toString().equals("reservado", ignoreCase = true) or txt52!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/quinta/18")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt58.setText(mensagem)
         if (txt58.getText().toString().equals("reservado", ignoreCase = true) or txt58!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/8")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt05.setText(mensagem)
         if (txt05.getText().toString().equals("reservado", ignoreCase = true) or txt05!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/9")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt5.setText(mensagem)
         if (txt5.getText().toString().equals("reservado", ignoreCase = true) or txt5!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/10")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt11.setText(mensagem)
         if (txt11.getText().toString().equals("reservado", ignoreCase = true) or txt11!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/11")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt17.setText(mensagem)
         if (txt17.getText().toString().equals("reservado", ignoreCase = true) or txt17!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/12")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt23.setText(mensagem)
         if (txt23.getText().toString().equals("reservado", ignoreCase = true) or txt23!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/13")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt29.setText(mensagem)
         if (txt29.getText().toString().equals("reservado", ignoreCase = true) or txt29!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/14")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt35.setText(mensagem)
         if (txt35.getText().toString().equals("reservado", ignoreCase = true) or txt35!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/15")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt41.setText(mensagem)
         if (txt41.getText().toString().equals("reservado", ignoreCase = true) or txt41!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/16")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt47.setText(mensagem)
         if (txt47.getText().toString().equals("reservado", ignoreCase = true) or txt47!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/17")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt53.setText(mensagem)
         if (txt53.getText().toString().equals("reservado", ignoreCase = true) or txt53!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sexta/18")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt59.setText(mensagem)
         if (txt59.getText().toString().equals("reservado", ignoreCase = true) or txt59!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/8")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt06.setText(mensagem)
         if (txt06.getText().toString().equals("reservado", ignoreCase = true) or txt06!!.getText().toString().equals("indisponivel")) {
     ...
     ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/9")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt6.setText(mensagem)
         if (txt6.getText().toString().equals("reservado", ignoreCase = true) or txt6!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/10")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt12.setText(mensagem)
         if (txt12.getText().toString().equals("reservado", ignoreCase = true) or txt12!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/11")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt18.setText(mensagem)
         if (txt18.getText().toString().equals("reservado", ignoreCase = true) or txt18!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/12")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt24.setText(mensagem)
         if (txt24.getText().toString().equals("reservado", ignoreCase = true) or txt24!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/13")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt30.setText(mensagem)
         if (txt30.getText().toString().equals("reservado", ignoreCase = true) or txt30!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/14")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt36.setText(mensagem)
         if (txt36.getText().toString().equals("reservado", ignoreCase = true) or txt36!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/15")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt42.setText(mensagem)

         if (txt42.getText().toString().equals("reservado", ignoreCase = true) or txt42!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/16")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt48.setText(mensagem)
         if (txt48.getText().toString().equals("reservado", ignoreCase = true) or txt48!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/17")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt54.setText(mensagem)
         if (txt54.getText().toString().equals("reservado", ignoreCase = true) or txt54!!.getText().toString().equals("indisponivel")) {
 ...
 ref = objetoRef.getReferenceFromUrl("https://hrbarbearia-26ab4.firebaseio.com/sabado/18")
 ref.addValueEventListener(object : ValueEventListener {
     override fun onDataChange(dataSnapshot: DataSnapshot) {
         val mensagem = dataSnapshot.getValue(String::class.java)
         txt60.setText(mensagem)
         if (txt60.getText().toString().equals("reservado", ignoreCase = true) or txt60!!.getText().toString().equals("indisponivel")) {
 ...
 var a01 = "" ;var b01 = ""; var b02 = "" ;var b03 = "" ;var b04 = "" ;var b05 = ""
 var b1 = ""  ;var b2 = "" ; var b3 = "" ; var b4 = ""  ;var b5 = ""  ;var b6= ""
 var b7 = "" ; var b8 = ""  ;var b9 = "" ; var b10 = "" ;var b11 = "" ;var b12= ""
 var b13 = "" ;var b14 = "" ;var b15 = "" ;var b16 = "" ;var b17 = "" ;var b18 = ""
 var b19 = "" ;var b20 = "" ;var b21 = "" ;var b22 = "" ;var b23 = "" ;var b24= ""
 var b25 = "" ;var b26 = "" ;var b27 = "" ;var b28 = "" ;var b29 = "" ;var b30 = ""
 var b31 = "" ;var b32 = "" ;var b33 = "" ;var b34 = "" ;var b35 = "" ;var b36 = ""
 var b37 = "" ;var b38 = "" ;var b39 = "" ;var b40 = "" ;var b41 = "" ;var b42 = ""
 var b43 = "" ;var b44 = "" ;var b45 = "" ;var b46 = "" ;var b47 = "" ;var b48 = ""
 var b49 = "" ;var b50 = "" ;var b51 = "" ;var b52 = "" ;var b53 = "" ;var b54 = ""
 var b55 = "" ;var b56 = "" ;var b57 = "" ;var b58 = "" ;var b59 = "" ;var b60 = ""

 txt01.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     var seg = segunda.getText().toString()
         ...
         hora.setText("08:00")
     } else { a01 = "disponivel" ;txt01.setBackgroundResource(R.drawable.botao)} })
 txt02.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("08:00")
 } else { b01 = "disponivel";txt02.setBackgroundResource(R.drawable.botao) } })
 txt03.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("08:00")
 } else { b02 = "disponivel" ;txt03.setBackgroundResource(R.drawable.botao)} })
 txt04.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("08:00")
 } else { b03 = "disponivel";txt04.setBackgroundResource(R.drawable.botao) } })
 txt05.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("08:00")
 } else {b04 = "disponivel" ;txt05.setBackgroundResource(R.drawable.botao)} })
 txt06.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("08:00")
 } else {b05 = "disponivel" ;txt06.setBackgroundResource(R.drawable.botao)} })
 txt1.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("09:00")
 } else { b1 = "disponivel";txt1.setBackgroundResource(R.drawable.botao)} })
 txt2.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("09:00")
 } else { b2 = "disponivel" ;txt2.setBackgroundResource(R.drawable.botao)} })
 txt3.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("09:00")
 } else { b3 = "disponivel";txt3.setBackgroundResource(R.drawable.botao) } })
 txt4.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("09:00")
 } else {b4 = "disponivel" ;txt4.setBackgroundResource(R.drawable.botao)} })
 txt5.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("09:00")
 } else {b5 = "disponivel";txt5.setBackgroundResource(R.drawable.botao) } })
 txt6.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("09:00")
 } else {b6 = "disponivel" ;txt6.setBackgroundResource(R.drawable.botao)} })
 txt7.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("10:00")
 } else { b7 = "disponivel";txt7.setBackgroundResource(R.drawable.botao) } })
 txt8.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("10:00")
 } else { b8 = "disponivel";txt8.setBackgroundResource(R.drawable.botao) } })
 txt9.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("10:00")
 } else { b9 = "disponivel" ;txt9.setBackgroundResource(R.drawable.botao)} })
 txt10.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("10:00")
 } else { b10 = "disponivel";txt10.setBackgroundResource(R.drawable.botao) } })
 txt11.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("10:00")
 } else {b11 = "disponivel";txt11.setBackgroundResource(R.drawable.botao)} })
 txt12.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("10:00")
 } else { b12 = "disponivel" ;txt12.setBackgroundResource(R.drawable.botao)} })
 txt13.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("11:00")
 } else {b13 = "disponivel" ;txt13.setBackgroundResource(R.drawable.botao)} })
 txt14.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("11:00")
 } else {b14 = "disponivel";txt14.setBackgroundResource(R.drawable.botao) } })
 txt15.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("11:00")
 } else { b15 = "disponivel";txt15.setBackgroundResource(R.drawable.botao) } })
 txt16.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("11:00")
 } else { b16 = "disponivel";txt16.setBackgroundResource(R.drawable.botao) } })
 txt17.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("11:00")
 } else { b17 = "disponivel" ;txt17.setBackgroundResource(R.drawable.botao)} })
 txt18.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("11:00")
 } else { b18 = "disponivel" ;txt18.setBackgroundResource(R.drawable.botao)} })
 txt19.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("12:00")
 } else { b19 = "disponivel" ;txt19.setBackgroundResource(R.drawable.botao)} })
 txt20.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("12:00")
 } else { b20 = "disponivel";txt20.setBackgroundResource(R.drawable.botao) } })
 txt21.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("12:00")
 } else { b21 = "disponivel" ;txt21.setBackgroundResource(R.drawable.botao)} })
 txt22.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("12:00")
 } else {  b22 = "disponivel" ;txt22.setBackgroundResource(R.drawable.botao)} })
 txt23.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("12:00")
 } else { b23 = "disponivel";txt23.setBackgroundResource(R.drawable.botao) } })
 txt24.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("12:00")
 } else { b24 = "disponivel" ;txt24.setBackgroundResource(R.drawable.botao)} })
 txt25.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("13:00")
 } else {  b25 = "disponivel";txt25.setBackgroundResource(R.drawable.botao) } })
 txt26.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("13:00")
 } else {  b26 = "disponivel" ;txt26.setBackgroundResource(R.drawable.botao)} })
 txt27.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("13:00")
 } else {  b27 = "disponivel" ;txt27.setBackgroundResource(R.drawable.botao)} })
 txt28.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("13:00")
 } else {  b28 = "disponivel";txt28.setBackgroundResource(R.drawable.botao) } })
 txt29.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("13:00")
 } else {  b29 = "disponivel" ;txt29.setBackgroundResource(R.drawable.botao)} })
 txt30.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("13:00")
 } else {  b30 = "disponivel"  ;txt30.setBackgroundResource(R.drawable.botao)} })
 txt31.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("14:00")
 } else { b31 = "disponivel" ;txt31.setBackgroundResource(R.drawable.botao) } })
 txt32.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("14:00")
 } else { b32 = "disponivel" ;txt32.setBackgroundResource(R.drawable.botao) } })
 txt33.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("14:00")
 } else {  b33 = "disponivel" ;txt33.setBackgroundResource(R.drawable.botao) } })
 txt34.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("14:00")
 } else {  b34 = "disponivel" ;txt34.setBackgroundResource(R.drawable.botao) } })
 txt35.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("14:00")
 } else {  b35 = "disponivel"  ;txt35.setBackgroundResource(R.drawable.botao)} })
 txt36.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("14:00")
 } else {  b36 = "disponivel" ;txt36.setBackgroundResource(R.drawable.botao) } })
 txt37.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("15:00")
 } else {  b37 = "disponivel"  ;txt37.setBackgroundResource(R.drawable.botao)} })
 txt38.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("15:00")
 } else {  b38 = "disponivel" ;txt38.setBackgroundResource(R.drawable.botao) } })
 txt39.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("15:00")
 } else { b39 = "disponivel" ;txt39.setBackgroundResource(R.drawable.botao)} })
 txt40.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("15:00")
 } else {  b40 = "disponivel" ;txt40.setBackgroundResource(R.drawable.botao)} })
 txt41.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("15:00")
 } else {  b41 = "disponivel";txt41.setBackgroundResource(R.drawable.botao) } })
 txt42.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("15:00")
 } else {  b42 = "disponivel";txt42.setBackgroundResource(R.drawable.botao) } })
 txt43.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("16:00")
 } else {  b43 = "disponivel";txt43.setBackgroundResource(R.drawable.botao) } })
 txt44.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("16:00")
 } else {  b44 = "disponivel" ;txt44.setBackgroundResource(R.drawable.botao)} })
 txt45.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("16:00")
 } else {  b45 = "disponivel";txt45.setBackgroundResource(R.drawable.botao) } })
 txt46.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("16:00")
 } else {  b46 = "disponivel" ;txt46.setBackgroundResource(R.drawable.botao)} })
 txt47.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("16:00")
 } else {  b47 = "disponivel";txt47.setBackgroundResource(R.drawable.botao) } })
 txt48.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("16:00")
 } else { b48 = "disponivel";txt48.setBackgroundResource(R.drawable.botao) } })
 txt49.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("17:00")
 } else {  b49 = "disponivel" ;txt49.setBackgroundResource(R.drawable.botao)} })
 txt50.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("17:00")
 } else {  b50 = "disponivel" ;txt50.setBackgroundResource(R.drawable.botao)} })
 txt51.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("17:00")
 } else {  b51 = "disponivel";txt51.setBackgroundResource(R.drawable.botao) } })
 txt52.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("17:00")
 } else {  b52 = "disponivel" ;txt52.setBackgroundResource(R.drawable.botao)} })
 txt53.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("17:00")
 } else {  b53 = "disponivel";txt53.setBackgroundResource(R.drawable.botao) } })
 txt54.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("17:00")
 } else {  b54 = "disponivel";txt54.setBackgroundResource(R.drawable.botao) } })
 txt55.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEGUNDA")
     hora.setText("18:00")
 } else {  b55 = "disponivel" ;txt55.setBackgroundResource(R.drawable.botao)} })
 txt56.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("TERCA")
     hora.setText("18:00")
 } else {  b56 = "disponivel";txt56.setBackgroundResource(R.drawable.botao) } })
 txt57.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUARTA")
     hora.setText("18:00")
 } else {  b57 = "disponivel" ; txt57.setBackgroundResource(R.drawable.botao)} })
 txt58.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("QUINTA")
     hora.setText("18:00")
 } else {  b58 = "disponivel"; txt58.setBackgroundResource(R.drawable.botao) } })
 txt59.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SEXTA")
     hora.setText("18:00")
 } else {  b59 = "disponivel"; txt59.setBackgroundResource(R.drawable.botao)} })
 txt60.setOnCheckedChangeListener({ buttonView, isChecked -> if (isChecked) {
     ...
     data.setText("SABADO")
     hora.setText("18:00")
 } else {  b60 = "disponivel";txt60.setBackgroundResource(R.drawable.botao)} })
...
val calendar = Calendar.getInstance(TimeZone.getDefault())
 ...
 val min = calendar.get(Calendar. MINUTE)
        ...
        if (days==1){ segunda.setText(dt2);terca.setText(dt3);quarta.setText(dt4);quinta.setText(dt5);sexta.setText(dt6);sabado.setText(dt7) }
        if (days==2){ segunda.setText(dt1);terca.setText(dt2);quarta.setText(dt3);quinta.setText(dt4);sexta.setText(dt5);sabado.setText(dt6) }
        if (days==3){ segunda.setText(dt7);terca.setText(dt1);quarta.setText(dt2);quinta.setText(dt3);sexta.setText(dt4);sabado.setText(dt5) }
        if (days==4){ segunda.setText(dt6);terca.setText(dt7);quarta.setText(dt1);quinta.setText(dt2);sexta.setText(dt3);sabado.setText(dt4) }
        if (days==5){ segunda.setText(dt5);terca.setText(dt6);quarta.setText(dt7);quinta.setText(dt1);sexta.setText(dt2);sabado.setText(dt3) }
        if (days==6){ segunda.setText(dt4);terca.setText(dt5);quarta.setText(dt6);quinta.setText(dt7);sexta.setText(dt1);sabado.setText(dt2) }
        if (days==7){ segunda.setText(dt3);terca.setText(dt4);quarta.setText(dt5);quinta.setText(dt6);sexta.setText(dt7);sabado.setText(dt1)}
...
limparCampos()
val toast = Toast.makeText(this, "Dados enviados com sucesso!", Toast.LENGTH_LONG)
